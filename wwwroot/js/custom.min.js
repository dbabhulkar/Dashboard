...
function ClearFields() {
    $("#tbl_FacilityDetails").empty();
    $("#tbl_OtherCharges").empty();
    $("#tbl_ipCollateral").empty();
    $("#tbl_Promoters").empty();
    $("#txt_justification").val('');
    $("#txt_customerName").val('');
    $("#DropDown_Level1").empty();
    $("#DropDown_Level2").empty();
    $("#DropDown_Level3").empty();
    $("#DropDown_Level4").empty();
    $("#DropDown_Level5").empty();
}
...
$("#btnAppLink").on("click", function () {

    //$("#sidebar_quicklinks").addClass('opened')
